...
@interface katizoTypeViewController ()


@end

@implementation katizoTypeViewController
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    katizoModelsViewController *modelViewController = [segue destinationViewController];
    
    modelViewController.makesYearSelected = [segue identifier];
    modelViewController.typeSelected = self.vehicleType;
}
